...
#R0<-function(x){1.1+0.9*exp(-x/10)}
...
#betast<-sapply(0:510,FUN=function(x){R0(x)*(gama1+gama1+gama3+gama4)/4})
...
pdf(file =paste0("Total_Compartimento_15_09_omega", days, ".pdf") )
...
pdf(file =paste0("Compartimento_Estado_15_09_omega", days, ".pdf"))
